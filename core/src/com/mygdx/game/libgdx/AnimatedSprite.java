...
public class AnimatedSprite extends Sprite {
    ...
    /** creates a new {@link net.dermetfan.gdx.graphics.g2d.AnimatedSprite} with the given {@link Animation}
    ...
    /** updates the {@link net.dermetfan.gdx.graphics.g2d.AnimatedSprite} with the delta time fetched from {@link Graphics#getDeltaTime()  Gdx.graphics.getDeltaTime()} */
    public void update() {
        update(Gdx.graphics.getDeltaTime());
    }

    /** updates the {@link net.dermetfan.gdx.graphics.g2d.AnimatedSprite} with the given delta time */
    ...
    /** @return if this {@link net.dermetfan.gdx.graphics.g2d.AnimatedSprite} is playing */
    public boolean isPlaying() {
        return playing;
    }

    /** @param playing if the {@link net.dermetfan.gdx.graphics.g2d.AnimatedSprite} should be playing */
